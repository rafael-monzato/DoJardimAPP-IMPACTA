...
class _CardCarrinhoState extends State<CardCarrinho> {
  ...
  Widget build(BuildContext context) {
    excluirProduto(id) {
      http.get(Uri.encodeFull(conf + "carrinho/excluir.php?id=${id}"),
          headers: {"Accept": "application/json"});

      Navigator.of(context).push(MaterialPageRoute(
          builder: (BuildContext context) =>
              Tabs(widget._cpf, "", "", "Carrinho")));
    }

    addQuantidade(id) {
      http.get(Uri.encodeFull(conf + "carrinho/addQuantidade.php?id=${id}"),
          headers: {"Accept": "application/json"});
    ...
    removerQuantidade(id) {
      http.get(Uri.encodeFull(conf + "carrinho/removerQuantidade.php?id=${id}"),
          headers: {"Accept": "application/json"});
